...
struct BgConst {
    struct Url {
        //http://private-ef689-matrixposauth.apiary-mock.com
    ...
    struct Key {
        ...
        static let NotifEditOrderFromSummary = "editFromCellPressed"
        static let NotifCancelOrderFromSummary = "cancelFromCellPressed"
    }
}
